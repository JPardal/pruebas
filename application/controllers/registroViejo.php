...
class Registro extends CI_Controller {
	...
	function email_check()
	{
		...
		<style type="text/css"> 
		body{margin:0;width:100%;height:25%} 
		...
		<body>
                <div>
		<p> Muchas gracias por registrarte en eSportics!</p>
		...
		<p> Facebook: <a href="http://www.facebook.com/eSportics" target="_blank" title="Sígueme en Facebook"><img src="http://quesabis.bligoo.cl/media/users/8/441100/images/public/34362/icono-facebook.png?v=1344599754904" width="24" height="24" alt="" style="position:fixed" /></a></p>
		<p> Twitter: <a href="https://twitter.com/eSportics" target="_blank" title="Sígueme en Twitter"><img src="http://www.nu.org.bo/portals/0/OIM/icono_twitter.png" width="24" height="24" alt="" style="position:fixed"/></a> </p>
		<p> Mail: <A HREF="mailto:info@esportics.com" target="_blank" title="info@esportics.com"><img src="http://www.fifcomputer.com/3.0/images/logo-Mail.png" width="24" height="24" alt="" style="position:fixed"/></a> </p>
		<div id="logo"> <a href="http://www.esportics.com"><img src="http://www.esportics.com/images/logo.png" /></a></div>
                </div>
                </body>
		</html>';
